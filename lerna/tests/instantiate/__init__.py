...
class UntypedPassthroughConf:
    _target_: str = "lerna.tests.instantiate.UntypedPassthroughClass"
    a: Any = MISSING
...
class CenterCropConf(TransformConf):
    _target_: str = "lerna.tests.instantiate.CenterCrop"
...
class RotationConf(TransformConf):
    _target_: str = "lerna.tests.instantiate.Rotation"
    degrees: int = MISSING
...
class SimpleClassPrimitiveConf:
    _target_: str = "lerna.tests.instantiate.SimpleClass"
