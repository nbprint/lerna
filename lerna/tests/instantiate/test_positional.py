...
from lerna.tests.instantiate import ArgsClass
...
@mark.parametrize(
    ...
    [
        ...
        param(
            {"_target_": "lerna.tests.instantiate.ArgsClass", "_args_": [1]},
            ArgsClass(1),
            id="config:args_only",
        ),
        param(
...
@mark.parametrize(
    ...
    [
        param(
            {"_target_": "lerna.tests.instantiate.ArgsClass", "_args_": {"foo": "bar"}},
            dedent(
                """\
                Error in collecting args and kwargs for 'lerna.tests.instantiate\\.ArgsClass':
...
@mark.parametrize(
    ...
    [
        param(
            {"_target_": "lerna.tests.instantiate.ArgsClass", "_args_": ["${.1}", 2]},
            ArgsClass(2, 2),
            id="config:args_only",
        ),
        param(
        ...
        param(
            ...
            ArgsClass(foo="lerna.tests.instantiate.ArgsClass"),
            id="config:kwargs_only)",
        ),
    ],
)
...
def test_instantiate_args_kwargs_with_override(cfg: Any, args_override: Any, expected: Any, kwargs_override: Any) -> None:
...
@mark.parametrize(
    ...
    [
        param(
            {
                "_target_": "lerna.tests.instantiate.ArgsClass",
                "child": {"_target_": "lerna.tests.instantiate.ArgsClass"},
            },
...
def test_recursive_instantiate_args_kwargs_with_override(cfg: Any, args_override: Any, expected: Any, kwargs_override: Any) -> None:
    assert instantiate(cfg, *args_override, **kwargs_override) == expected
