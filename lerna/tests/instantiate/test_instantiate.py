    ...
    [
        ...
        param(
            [
                ...
                {
                    "_target_": "lerna.tests.instantiate.BClass",
                    "a": 50,
                    "b": 60,
                    "c": 70,
                },
        ...
        param(
            {"_target_": "lerna.tests.instantiate.AClass", "b": 200, "c": "${b}"},
            {"a": 10, "b": 99, "d": 40},
            AClass(10, 99, 99, 40),
        ...
        param(
            {"_target_": "lerna.tests.instantiate.ASubclass.class_method", "_partial_": True},
            {},
            partial(ASubclass.class_method),
            id="class_method+partial",
        ),
        param(
            {"_target_": "lerna.tests.instantiate.ASubclass.class_method", "y": 10},
            {},
            ASubclass(11),
            id="class_method",
        ),
        param(
            {"_target_": "lerna.tests.instantiate.AClass.static_method", "_partial_": True},
            {},
        ...
        param(
            {
                "_target_": "lerna.tests.instantiate.AClass.static_method",
                "_partial_": True,
                "y": "???",
            },
            {},
        ...
        param(
            {"_target_": "lerna.tests.instantiate.AClass.static_method", "z": 43},
            {},
            43,
            id="static_method",
        ),
        ...
        param(
            {"_target_": "lerna.tests.instantiate.NestingClass"},
            {},
            NestingClass(ASubclass(10)),
            id="class_with_nested_class",
        ),
        param(
            {"_target_": "lerna.tests.instantiate.nesting.a.class_method", "_partial_": True},
            {},
            partial(ASubclass.class_method),
            id="class_method_on_an_object_nested_in_a_global+partial",
        ),
        param(
            {"_target_": "lerna.tests.instantiate.nesting.a.class_method", "y": 10},
            {},
            ASubclass(11),
        ...
        param(
            {
                "_target_": "lerna.tests.instantiate.nesting.a.static_method",
                "_partial_": True,
            },
            {},
        ...
        param(
            {"_target_": "lerna.tests.instantiate.nesting.a.static_method", "z": 43},
            {},
            43,
        ...
        param(
            {
                "_target_": "lerna.tests.instantiate.module_function",
                "_partial_": True,
            },
            {},
        ...
        param(
            {"_target_": "lerna.tests.instantiate.module_function", "x": 43},
            {},
            43,
            id="call_function_in_module",
        ),
        ...
        param(
            {"_target_": "lerna.tests.instantiate.AClass", "_partial_": True},
...
def test_none_cases(
    ...
    cfg = {
        "_target_": "lerna.tests.instantiate.ArgsClass",
...
@mark.parametrize(
    ...
    [
        ...
        param(
            {
                "A": {"_target_": "lerna.tests.instantiate.add_values", "a": 1, "b": 2},
                "node": {
                    "_target_": "lerna.tests.instantiate.add_values",
                    "_partial_": True,
                    "a": "${A}",
                },
            },
            ...
            DictConfig(
                {
                    "username": "test_user",
                    "node": {
                        "_target_": "lerna.tests.instantiate.TargetWithInstantiateInInit",
                        "_recursive_": False,
                        "user_config": {
                            "_target_": "lerna.tests.instantiate.User",
                            "name": "${foo_b.username}",
                            "age": 40,
                        },
                    },
...
@mark.parametrize("src", [{"_target_": "lerna.tests.instantiate.Adam"}])
def test_instantiate_adam(instantiate_func: Any, config: Any) -> None:
    with raises(
        InstantiationException,
        match=r"Error in call to target 'lerna.tests.instantiate\.Adam':\nTypeError\(.*\)",
    ):
...
def test_instantiate_with_missing_module(instantiate_func: Any) -> None:
    _target_ = "lerna.tests.instantiate.ClassWithMissingModule"
    with raises(
        InstantiationException,
        match=dedent(
            rf"""
...
def test_instantiate_target_raising_exception_taking_no_arguments(
    ...
    _target_ = "lerna.tests.instantiate.raise_exception_taking_no_argument"
    with raises(
        InstantiationException,
        match=(
            dedent(
...
def test_toplevel_list_partial_not_allowed(instantiate_func: Any) -> None:
    config = [{"_target_": "lerna.tests.instantiate.ClassA", "a": 10, "b": 20, "c": 30}]
    with raises(
        InstantiationException,
...
def test_pass_extra_variables(instantiate_func: Any, is_partial: bool) -> None:
    ...
    if is_partial:
        assert partial_equal(instantiate_func(cfg, c=30), partial(AClass, a=10, b=20, c=30))
    else:
...
def test_instantiate_with_callable_target_keyword(instantiate_func: Any, target: Callable[[], None], expected: Callable[[Any], bool]) -> None:
...
@mark.parametrize(
    ...
    [
        ...
        param(
            {
                "_target_": "lerna.tests.instantiate.Tree",
                "value": 1,
                "left": {
                    "_target_": "lerna.tests.instantiate.Tree",
                    "value": 21,
        ...
        param(
            {"_target_": "lerna.tests.instantiate.Tree"},
            {"value": 1, "left": {"_target_": "lerna.tests.instantiate.Tree", "value": 2}},
        ...
        param(
            ...
            {
                "value": 1,
                "left": {"_target_": "lerna.tests.instantiate.Tree", "value": 2},
                "right": {"_target_": "lerna.tests.instantiate.Tree", "value": 3},
            },
        ...
        param(
            ...
            {
                "value": 1,
                "left": {"_target_": "lerna.tests.instantiate.Tree", "value": IllegalType()},
            },
        ...
        param(
            {
                "_target_": "lerna.tests.instantiate.Compose",
                "transforms": [
                    {"_target_": "lerna.tests.instantiate.CenterCrop", "size": 10},
                    {"_target_": "lerna.tests.instantiate.Rotation", "degrees": 45},
                ],
            },
            {},
            Compose(
        ...
        param(
            {
                "_target_": "lerna.tests.instantiate.Mapping",
                "dictionary": {
                    "a": {"_target_": "lerna.tests.instantiate.Mapping"},
                    "b": {"_target_": "lerna.tests.instantiate.Mapping"},
                },
            },
            {},
            Mapping(
...
@mark.parametrize(
    ...
    [
        ...
        param(
            {"_target_": "lerna.tests.instantiate.Tree", "_partial_": True},
            {"value": 1},
        ...
        param(
            ...
            {
                "value": 1,
                "left": {"_target_": "lerna.tests.instantiate.Tree", "_partial_": True},
            },
        ...
        param(
            {
                "_target_": "lerna.tests.instantiate.Compose",
                "transforms": [
                    {"_target_": "lerna.tests.instantiate.CenterCrop", "_partial_": True},
                    {"_target_": "lerna.tests.instantiate.Rotation", "degrees": 45},
                ],
            },
            {},
        ...
        param(
            {
                ...
                "_partial_": True,
                "dictionary": {
                    "a": {"_target_": "lerna.tests.instantiate.Mapping", "_partial_": True},
                },
            },
            {
                "dictionary": {
                    "b": {"_target_": "lerna.tests.instantiate.Mapping", "_partial_": True},
                },
            },
            partial(
                Mapping,
...
@mark.parametrize(
    ...
    [
        ...
        param(
            ...
            {"_recursive_": False},
            Tree(value=1, left={"_target_": "lerna.tests.instantiate.Tree", "value": 21}),
        ...
        param(
            ...
            Tree(
                ...
                left={
                    "_target_": "lerna.tests.instantiate.Tree",
                    "value": 2,
                    "left": {"_target_": "lerna.tests.instantiate.Tree", "value": 3},
                },
            ),
        ...
        param(
            ...
            Tree(
                value=1,
                left=Tree(value=2, left={"_target_": "lerna.tests.instantiate.Tree", "value": 3}),
            ),
...
@mark.parametrize(
    ...
    [
        ...
        param(
            {"_target_": "lerna.tests.instantiate.AClass", "a": 10, "b": 20},
            {"_target_": "lerna.tests.instantiate.BClass"},
            BClass(10, 20, "c", "d"),
...
def test_override_target(instantiate_func: Any, config: Any, passthrough: Any, expected: Any) -> None:
    obj = instantiate_func(config, **passthrough)
    assert obj == expected
...
def test_instantiate_from_class_in_dict(instantiate_func: Any, config: Any, passthrough: Any, expected: Any) -> None:
...
@mark.parametrize(
    ...
    [
        param(
            ...
            {},
            re.escape("Expected a callable target, got" + " '{'a': '???', 'b': '???', 'c': '???', 'd': 'default_value'}' of type 'DictConfig'"),
        ...
        param(
            {
                "value": 99,
                "obj": {
                    "_target_": "lerna.tests.instantiate.SimpleClass",
                    "a": {
                        "_target_": "lerna.tests.instantiate.SimpleClass",
                        "a": {"foo": "${value}"},
                        "b": [1, "${value}"],
...
def test_convert_params(instantiate_func: Any, input_: Any, expected: Any, convert_mode: Any) -> None:
...
def test_convert_and_recursive_node(instantiate_func: Any, nested_recursive: bool) -> None:
    cfg = {
        "_target_": "lerna.tests.instantiate.SimpleClass",
        "a": {
            "_target_": "lerna.tests.instantiate.SimpleClass",
...
def test_instantiated_regular_class_container_types(instantiate_func: Any, mode: Any, expected_dict: Any, expected_list: Any) -> None:
    cfg = {"_target_": "lerna.tests.instantiate.SimpleClass", "a": {}, "b": []}
    ...
    cfg2 = {
        "_target_": "lerna.tests.instantiate.SimpleClass",
        "a": {"_target_": "lerna.tests.instantiate.SimpleClass", "a": {}, "b": []},
        "b": [{"_target_": "lerna.tests.instantiate.SimpleClass", "a": {}, "b": []}],
    }
...
def test_instantiated_regular_class_container_types_object__recursive(instantiate_func: Any, config: Any) -> None:
...
@mark.parametrize(
    ...
    [
        param(
            {
                "value": 99,
                "obj": SimpleClassPrimitiveConf(a={"foo": "${value}"}, b=[1, "${value}"]),
            },
            True,
            SimpleClass(a={"foo": 99}, b=[1, 99]),
        ...
        param(
            {
                "value": 99,
                "obj": SimpleClassNonPrimitiveConf(a={"foo": "${value}"}, b=[1, "${value}"]),
            },
            False,
            SimpleClass(a={"foo": 99}, b=[1, 99]),
        ...
        param(
            {
                "value": 99,
                "obj": SimpleClassDefaultPrimitiveConf(a={"foo": "${value}"}, b=[1, "${value}"]),
            },
            False,
            SimpleClass(a={"foo": 99}, b=[1, 99]),
            id="default_behavior",
