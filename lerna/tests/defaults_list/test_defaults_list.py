...
from lerna.tests.defaults_list import create_repo
...
def test_get_paths(default: InputDefault, expected_group_path: Any, expected_config_path: Any) -> None:
...
def test_get_final_package(default: InputDefault, parent_package: str, parent_base_dir: str, expected: Any) -> None:
    default.update_parent(parent_base_dir=parent_base_dir, parent_package=parent_package)
...
@mark.parametrize(
    ...
    [
        ...
        param(
            ...
            [],
            [
                ResultDefault(config_path="group1/file1", package="group1", parent="group_default"),
        ...
        param(
            ...
            [
                ...
                ResultDefault(config_path="group1/file1", package="group1", parent="self_leading"),
            ],
            id="self_leading",
        ),
        param(
            ...
            [],
            [
                ResultDefault(config_path="group1/file1", package="group1", parent="self_trailing"),
        ...
        param(
            ...
            [
                ...
                ResultDefault(config_path="include_nested_group", package="", is_self=True),
            ],
...
@mark.parametrize(
    ...
    [
        param(
            ...
            [],
            [
                ResultDefault(config_path="empty", package="pkg1", parent="config_default_pkg1"),
                ResultDefault(config_path="config_default_pkg1", package="", is_self=True),
            ],
    ...
    [
        param(
            ...
            [
                ...
                ResultDefault(config_path="include_nested_group_pkg2", package="", is_self=True),
            ],
    ...
    [
        param(
            ...
            [
                ...
                ResultDefault(config_path="group_default_pkg1", package="", is_self=True),
            ],
...
@mark.parametrize(
    ...
    [
        ...
        param(
            ...
            [
                ResultDefault(config_path="empty", package="", is_self=True, primary=True),
                ResultDefault(
                    config_path="group1/group2/file1_pkg_header_foo",
...
@mark.parametrize(
    ...
    [
        ...
        param(
            ...
            ["group1=file1"],
            [
                ResultDefault(config_path="group1/file1", package="group1", parent="placeholder"),
                ResultDefault(config_path="placeholder", package="", is_self=True),
            ],
        ...
        param(
            ...
            [
                ...
                ResultDefault(config_path="nested_placeholder", package="", is_self=True),
            ],
    ...
    [
        param(
            ...
            [
                ...
                ResultDefault(config_path="interpolation_simple", package="", is_self=True),
            ],
...
@mark.parametrize(
    ...
    [
        param(
            ...
            raises(
                ConfigCompositionException,
                match=re.escape("group1 appears more than once in the final defaults list"),
            ),
        ...
        param(
            ...
            raises(
                ConfigCompositionException,
                match=re.escape("group1/group2 appears more than once in the final defaults list"),
            ),
...
@mark.parametrize(
    ...
    [
        param(
            ...
            [],
            [ResultDefault(config_path="group1/file_with_group_header", package="_group_")],
...
@mark.parametrize(
    ...
    [
        ...
        param(
            ...
            True,
            [
                ResultDefault(config_path="db/base_db", package="db", parent="with_missing"),
                ResultDefault(config_path="with_missing", package="", is_self=True),
            ],
...
def test_set_package_header_no_parent_pkg(default: InputDefault, package_header: str, expected: str, recwarn: Any) -> None:
...
def test_set_package_header_with_parent_pkg(default: InputDefault, package_header: str, expected: str, recwarn: Any) -> None:
...
@mark.parametrize(
    ...
    [
        param(
            ...
            True,
            [
                ResultDefault(config_path="group1/file1", package="foo", parent="select_multi_pkg"),
                ResultDefault(config_path="group1/file2", package="foo", parent="select_multi_pkg"),
                ResultDefault(
