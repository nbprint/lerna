...
from lerna.tests.defaults_list import _test_defaults_tree_impl
    ...
    [
        ...
        param(
            ...
            raises(
                ...
                match=re.escape("Multiple values for group1. To override a value use 'override group1: file2'"),
            ),
        ...
        param(
            ...
            raises(
                ConfigCompositionException,
                match=re.escape("In 'invalid_override_in_defaults': Could not override 'foo'. No match in the defaults list.") + "$",
            ),
...
@mark.parametrize(
    ...
    [
        param(
            ...
            raises(
                ConfigCompositionException,
                match=re.escape("Multiple values for hydra/output. To override a value use 'override hydra/output: disabled'"),
            ),
            id="legacy_override_hydra2-error",
        ),
    ],
)
def test_legacy_hydra_overrides_from_primary_config_are_rejected(config_name: str, overrides: list[str], expected: DefaultsTreeNode) -> None:
    _test_defaults_tree_impl(
        config_name=config_name,
        input_overrides=overrides,
        expected=expected,
        ...
        param(
            ...
            DefaultsTreeNode(
                ...
                children=[
                    ...
                    ConfigDefault(path="_self_"),
                    DefaultsTreeNode(
                        node=GroupDefault(group="experiment", value="include_absolute_config"),
                        children=[
        ...
        param(
            ...
            DefaultsTreeNode(
                ...
                children=[
                    GroupDefault(group="group1", value="file2"),
                    ConfigDefault(path="_self_"),
                    GroupDefault(group="experiment", value="override_with_global_default"),
                ],
            ),
        ...
        param(
            ...
            DefaultsTreeNode(
                ...
                children=[
                    GroupDefault(group="group1", value="file2", package="_global_"),
                    ConfigDefault(path="_self_"),
                    GroupDefault(group="experiment", value="override_with_global_default2"),
                ],
            ),
...
@mark.parametrize(
    ...
    [
        ...
        param(
            ...
            [],
            DefaultsTreeNode(
                node=ConfigDefault(path="test_extend_from_config_with_same_name_as_group"),
                children=[
                    DefaultsTreeNode(
                        node=ConfigDefault(path="config_with_same_name_as_group"),
                        children=[
                            GroupDefault(group="config_with_same_name_as_group", value="item"),
                            ConfigDefault(path="_self_"),
                        ],
                    ),
                    ConfigDefault(path="_self_"),
        ...
        param(
            ...
            [],
            DefaultsTreeNode(
                node=ConfigDefault(path="test_extend_from_group_with_same_name_as_config"),
                children=[
...
@mark.parametrize(
    ...
    [
        ...
        param(
            ...
            raises(
                ConfigCompositionException,
                match=re.escape("Error resolving interpolation '${not_found}', possible interpolation keys: group1"),
            ),
    ...
    [
        ...
        param(
            ...
            DefaultsTreeNode(
                node=ConfigDefault(path="two_group_defaults_different_pkgs"),
                children=[
                    GroupDefault(group="group1", value="file1", package="pkg1", deleted=True),
                    GroupDefault(group="group1", value="file1", package="pkg2"),
                    ConfigDefault(path="_self_"),
                ],
            ),
        ...
        param(
            ...
            DefaultsTreeNode(
                ...
                children=[
                    GroupDefault(group="group1", value="file1", package="pkg1"),
                    GroupDefault(group="group1", value="file1", package="pkg2", deleted=True),
                    ConfigDefault(path="_self_"),
                ],
            ),
            id="delete:two_group_defaults_different_pkgs:delete_pkg1",
    ...
    [
        param(
            ...
            DefaultsTreeNode(
                ...
                children=[
                    ConfigDefault(path="empty"),
                    GroupDefault(group="foo", value="missing", optional=True, deleted=True),
                    ConfigDefault(path="_self_"),
                ],
            ),
...
@mark.parametrize(
    ...
    [
        ...
        param(
            ...
            raises(
                ConfigCompositionException,
                match=re.escape("In 'select_multi_interpolation': Defaults List interpolation is not supported in options list items"),
            ),
        ...
        param(
            ...
            DefaultsTreeNode(
                ...
                children=[
                    ...
                    ConfigDefault(path="group1/not_found2", deleted=True, optional=True),
                    ConfigDefault(path="_self_"),
                ],
            ),
    ...
    [
        param(
            ...
            raises(
                ConfigCompositionException,
                match=re.escape(
                    "In 'experiment/error_override_without_abs_and_header': Could not override 'experiment/group1'. No match in the defaults list"
                ),
            ),
        ...
        param(
            ...
            raises(
                ConfigCompositionException,
                match=re.escape(
                    "In 'experiment/error_override_without_global': Could not override 'group1@experiment.group1'. No match in the defaults list"
                ),
            ),
