...
from lerna._internal.utils import compute_search_path_dir
...
def test_compute_search_path_dir(calling_file: str, calling_module: str, config_path: str, expected: str) -> None:
