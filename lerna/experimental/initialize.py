...
from lerna.initialize import _UNSPECIFIED_
...
class initialize_config_module:
    ...
    def __init__(self, config_module: str, job_name: str = "app") -> None:
        from lerna import initialize_config_module as real_initialize_config_module

        message = "hydra.experimental.initialize_config_module() is no longer experimental. Use hydra.initialize_config_module()."
...
class initialize_config_dir:
    ...
    def __init__(self, config_dir: str, job_name: str = "app") -> None:
        from lerna import initialize_config_dir as real_initialize_config_dir
