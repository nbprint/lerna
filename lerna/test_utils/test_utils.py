...
def _chdir_to_dir_containing(target: str, max_up: int = 6, initial_dir: str = os.getcwd()) -> None:
...
"""
    ...
    try:
        ...
        if expected_outputs is not None:
            assert len(output) == len(expected_outputs), f"Unexpected number of output lines from {task_file}, output lines:\n\n{file_str}"
...
def assert_text_same(from_line: str, to_line: str, from_name: str = "Expected", to_name: str = "Actual") -> None:
...
def assert_regex_match(from_line: str, to_line: str, from_name: str = "Expected", to_name: str = "Actual") -> None:
...
def assert_multiline_regex_search(pattern: str, string: str, from_name: str = "Expected", to_name: str = "Actual") -> None:
